  ...
  return (
    <View style={[styles.switchRow, { borderColor: colors.border }]}>
      <View style={styles.switchLabelWrap}>
        ...
        {subtitle ? (
          <ThemedText style={[styles.switchSubtitle, { color: colors.mutedForeground }]}>
            {subtitle}
          </ThemedText>
        ) : null}
      </View>
    ...
    <ThemedView style={styles.container}>
      ...
      >
        ...
        <ThemedText style={[styles.pageSubtitle, { color: colors.mutedForeground }]}>
          Defina como prefere estudar: formato inicial, duração das sessões, tamanho do resumo, modo
          foco e mais.
        </ThemedText>
        ...
        >
          ...
          <View style={styles.field}>
            ...
            <Input
              value={displayName}
              editable={false}
              style={[styles.inputReadonly, { backgroundColor: colors.muted + "80" }]}
            />
          </View>
          <View style={styles.field}>
        ...
        >
          ...
          <View style={styles.field}>
            ...
            <ThemedText style={[styles.hint, { color: colors.mutedForeground }]}>
              Nas telas de estudo, o resumo pode ser exibido em 3 níveis (quando o PDF tiver sido
              processado com essa opção).
            </ThemedText>
            <OptionChips
        ...
        >
          ...
          <ThemedText style={[styles.hint, { color: colors.mutedForeground, marginBottom: 16 }]}>
            Nas telas de estudo, esconde resumo, abas e links. Mostra apenas o formato escolhido e o
            timer.
          </ThemedText>
          <RowSwitch
