...
export function ThemedText({
  ...
  const base = type === 'default' ? baseStyles.default
    : type === 'title' ? baseStyles.title
    : type === 'defaultSemiBold' ? baseStyles.defaultSemiBold
    : type === 'subtitle' ? baseStyles.subtitle
    : type === 'link' ? baseStyles.link
    : undefined;
