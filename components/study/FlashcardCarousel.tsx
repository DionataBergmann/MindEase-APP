    ...
    <View style={styles.wrapper}>
      <Pressable
        style={[
          ...
          { borderColor: colors.border, backgroundColor: colors.card, borderWidth: borderW },
        ]}
      ...
      {renderActions ? (
        ...
        <View style={styles.buttons}>
          <Button variant="outline" onPress={handlePrev} disabled={!hasPrev} style={styles.btn}>
            <Feather name="chevron-left" size={18} color={colors.primary} />
            <ThemedText style={{ color: colors.primary, fontWeight: "600" }}>Anterior</ThemedText>
          </Button>
          <Button variant="outline" onPress={handleNext} disabled={!hasNext} style={styles.btn}>
